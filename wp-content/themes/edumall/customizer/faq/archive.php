...
Edumall_Kirki::add_field( 'theme', array(
	'type'        => 'select',
	'settings'    => 'faq_archive_title_bar_layout',
	'label'       => esc_html__( 'Title Bar Style', 'edumall' ),
	'description' => esc_html__( 'Select default Title Bar that displays on archive faq pages.', 'edumall' ),
	'section'     => $section,
	'priority'    => $priority++,
...
Edumall_Kirki::add_field( 'theme', array(
	'type'        => 'text',
	'settings'    => 'faq_archive_title_bar_title',
	'label'       => esc_html__( 'Heading', 'edumall' ),
	'description' => esc_html__( 'Enter text that displays on archive faq pages.', 'edumall' ),
	'section'     => $section,
	'priority'    => $priority++,
	'default'     => esc_html__( 'faqs', 'edumall' ),
) );*/
