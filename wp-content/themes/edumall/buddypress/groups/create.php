...
bp_nouveau_groups_create_hook( 'before', 'page' ); ?>
	...
	<h2 class="bp-subhead"><?php esc_html_e( 'Create A New Group', 'edumall' ); ?></h2>
	...
	<?php endif; ?>
		...
		<div class="item-body" id="group-create-body">
			...
			<nav class="<?php bp_nouveau_groups_create_steps_classes(); ?>" id="group-create-tabs" role="navigation" aria-label="<?php esc_attr_e( 'Group creation menu', 'edumall' ); ?>">
