...
class Group_Control_Advanced_Border extends Group_Control_Base {
	...
	protected function init_fields() {
		...
		$fields['type'] = [
			'label'     => _x( 'Type', 'Border Control', 'edumall' ),
			'type'      => Controls_Manager::SELECT,
			'options'   => [
				''       => __( 'Default', 'edumall' ),
				'none'   => __( 'None', 'edumall' ),
				'solid'  => _x( 'Solid', 'Border Control', 'edumall' ),
				'double' => _x( 'Double', 'Border Control', 'edumall' ),
				'dotted' => _x( 'Dotted', 'Border Control', 'edumall' ),
				'dashed' => _x( 'Dashed', 'Border Control', 'edumall' ),
				'groove' => _x( 'Groove', 'Border Control', 'edumall' ),
			],
			'selectors' => [
		...
		$fields['color'] = [
			'label'     => _x( 'Color', 'Border Control', 'edumall' ),
		...
		$fields['width'] = [
			'label'      => _x( 'Width', 'Border Control', 'edumall' ),
		...
		$fields['radius'] = [
			'label'      => _x( 'Rounded', 'Border Control', 'edumall' ),
			'type'       => Controls_Manager::DIMENSIONS,
			'size_units' => [ 'px', '%' ],
			'selectors'  => [
	...
	protected function get_default_options() {
		return [
			'popover' => [
				'starter_title' => _x( 'Border', 'Advanced Border Control', 'edumall' ),
				'starter_name'  => 'enable',
				'starter_value' => 'yes',
				'settings'      => [
					'render_type' => 'ui',
