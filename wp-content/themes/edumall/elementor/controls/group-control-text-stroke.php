...
class Group_Control_Text_Stroke extends Group_Control_Base {
	...
	protected function init_fields() {
		...
		// Divider.
		$fields['fill'] = [
			'label'                => esc_html__( 'Fill', 'edumall' ),
			'label_block'          => false,
			'type'                 => Controls_Manager::CHOOSE,
			'options'              => array(
				'none'    => [
					'title' => esc_html__( 'Transparent', 'edumall' ),
					'icon'  => 'eicon-ban',
				],
				'initial' => [
					'title' => esc_html__( 'Normal', 'edumall' ),
	...
	protected function get_default_options() {
		return [
			'popover' => [
				'starter_title' => _x( 'Text Stroke', 'Text Stroke Control', 'edumall' ),
				'starter_name'  => 'enable',
				'starter_value' => 'yes',
				'settings'      => [
					'render_type' => 'ui',
