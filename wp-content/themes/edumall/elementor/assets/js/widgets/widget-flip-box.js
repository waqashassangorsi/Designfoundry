(
	function( $ ) {
		...
		var EdumallFlipBoxHandler = function( $scope, $ ) {
			var $element = $scope.find( '.edumall-flip-box' );
		...
		$( window ).on( 'elementor/frontend/init', function() {
			elementorFrontend.hooks.addAction( 'frontend/element_ready/tm-flip-box.default', EdumallFlipBoxHandler );
		} );
	}
)( jQuery );
