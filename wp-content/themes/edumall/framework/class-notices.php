...
if ( ! class_exists( 'Edumall_Notices' ) ) {

	class Edumall_Notices {
		...
		function get_notice_cookie_messages() {
			$messages    = Edumall::setting( 'notice_cookie_messages' );
			$button_text = Edumall::setting( 'notice_cookie_button_text' );
	...
	Edumall_Notices::instance()->initialize();
}
