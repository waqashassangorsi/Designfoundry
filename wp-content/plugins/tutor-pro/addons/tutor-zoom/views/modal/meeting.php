                    ...
                    <div class="tutor-quiz-builder-row">
                        <div class="tutor-quiz-builder-col meeting-time-col">
                            <div class="date-range-input">
                                <input type="text" name="meeting_date" class="tutor_zoom_datepicker readonly" value="<?php echo $start_date; ?>" autocomplete="off" placeholder="<?php echo date('Y-m-d'); ?>" required>
