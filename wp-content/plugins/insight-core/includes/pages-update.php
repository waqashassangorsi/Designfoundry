...
if ( ! current_user_can( 'update_themes' ) ) {
	wp_die( esc_html__( 'Sorry, you are not allowed to update this site.', 'insight-core' ) );
}
				...
				<div class="box-body">
					...
					if ( InsightCore::check_valid_update() ) {
						...
						$attrs = sprintf(
							...
							esc_attr( sprintf( __( 'Update %s now', 'insight-core' ), INSIGHT_CORE_THEME_NAME ) )
						);

						printf(
							__('There is a new version of %1$s available. <a href="%2$s" %3$s>Update now</a>.', 'insight-core'),
